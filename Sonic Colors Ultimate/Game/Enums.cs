namespace LiveSplit.SonicColors
{
    internal static class Levels
    {
        ...
        internal const string StarlightCarnivalAct2 = "stg310";
        internal const string StarlightCarnivalAct3 = "stg310";
        internal const string StarlightCarnivalAct4 = "stg310";
        internal const string StarlightCarnivalAct5 = "stg310";
        internal const string StarlightCarnivalAct6 = "stg310";
        internal const string StarlightCarnivalBoss = "stg310";
