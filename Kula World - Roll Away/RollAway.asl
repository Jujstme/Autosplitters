...
init
{
    ...
    // If the memoryoffset is still zero at this point, it's because the script failed to identify a supported emulator.
    // In this case, the script will throw an exception, which will make Livesplit reset the script.
    // This allows to hook into Retroarch correctly after a core is loaded.
